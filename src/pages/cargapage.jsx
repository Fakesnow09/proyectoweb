...
function CargaPage() {
  ...
  const editar = (carga) => {
    setForm({
      id: carga.idCarga,
      idTransporte: carga.idTransporte,
 ...
 const exportarAExcel = () => {
  ...
  saveAs(blob, `Reporte_Carga_${new Date().toISOString().split('T')[0]}.xlsx`);
};
      ...
      <div className="page-content">
        ...
        <form className="formulario-crud" onSubmit={handleSubmit}>
          <input
            type="number"
            name="idTransporte"
            value={form.idTransporte}
            onChange={handleChange}
            placeholder="Id_Transporte"
            required
          />
          <input
            type="text"
